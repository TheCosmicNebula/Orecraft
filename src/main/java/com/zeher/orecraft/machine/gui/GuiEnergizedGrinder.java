...
public class GuiEnergizedGrinder extends GuiContainer {
	private static final ResourceLocation texture = new ResourceLocation("orecraft:textures/gui/machine/energized/grinder/gui_grinder.png");
	private TileEntityEnergizedGrinder inventory;

	public GuiEnergizedGrinder(InventoryPlayer par1InventoryPlayer,
			TileEntityEnergizedGrinder par2TileEntityGrinder) {
