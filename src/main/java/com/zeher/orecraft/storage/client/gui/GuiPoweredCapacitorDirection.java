...
import com.zeher.orecraft.storage.core.container.ContainerPoweredCapacitorDirection;
...
public class GuiPoweredCapacitorDirection extends GuiContainer {
	...
	private TileEntityPoweredCapacitor tile;
	
	public GuiPoweredCapacitorDirection(InventoryPlayer inventoryPlayer, TileEntityPoweredCapacitor tileEntity) {
		super(new ContainerPoweredCapacitorDirection(inventoryPlayer, tileEntity));
