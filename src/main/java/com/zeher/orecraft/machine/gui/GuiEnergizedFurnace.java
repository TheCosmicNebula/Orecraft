...
public class GuiEnergizedFurnace extends GuiContainer {
	private static final ResourceLocation texture = new ResourceLocation("orecraft:textures/gui/machine/energized/furnace/gui_furnace.png");
	private TileEntityEnergizedFurnace inventory;

	public GuiEnergizedFurnace(InventoryPlayer par1InventoryPlayer,
			TileEntityEnergizedFurnace par2TileEntityFurnace) {
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int mouseX, int mouseY) {
		...
		drawTexturedModalRect(k + 83, l + 34, 176, 14, i1 + 1, 17);
	}
}
