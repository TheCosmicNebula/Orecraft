...
public class MachineCombinerRecipe implements ITRZRecipe
{
    ...
    public MachineCombinerRecipe(ItemStack output, List<ItemStack> list, ItemStack focus_stack, Integer process_time)
    {
