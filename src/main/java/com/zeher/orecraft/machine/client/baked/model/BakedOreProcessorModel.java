...
public class BakedOreProcessorModel implements IBakedModel {
	...
	public BakedOreProcessorModel(IBakedModel baseModel) {
	...
	public List<BakedQuad> getQuads(IBlockState state, EnumFacing side, long rand) {
		...
		if (MinecraftForgeClient.getRenderLayer() == BlockRenderLayer.CUTOUT_MIPPED) {
			...
			boolean cullFluidTop = exState.getValue(BlockPoweredOreProcessor.CullFluidTop);
			int fluidLevel = exState.getValue(BlockPoweredOreProcessor.FluidLevel);
			String fluidName = exState.getValue(BlockPoweredOreProcessor.FluidName);
