...
import com.zeher.orecraft.storage.core.container.ContainerMechanisedStorageLarge;
import com.zeher.orecraft.storage.core.tileentity.TileEntityMechanisedStorageLarge;

@SideOnly(Side.CLIENT)
public class GuiMechanisedStorageLarge extends GuiContainer {
	private static final ResourceLocation texture = new ResourceLocation(OrecraftReference.RESOURCE.GUI + "storage/mechanised/gui_mechanised_storage_large.png");
