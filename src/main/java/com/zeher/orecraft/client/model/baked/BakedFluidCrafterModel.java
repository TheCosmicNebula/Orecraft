...
public class BakedFluidCrafterModel implements IBakedModel
{
	...
	public BakedFluidCrafterModel(IBakedModel baseModel)
	{
	...
	public List<BakedQuad> getQuads(IBlockState state, EnumFacing side, long rand)
	{
		...
		else if (MinecraftForgeClient.getRenderLayer() == BlockRenderLayer.TRANSLUCENT)
		{
			...
			boolean cullFluidTop = exState.getValue(BlockPoweredFluidCrafter.CullFluidTop);
			int fluidLevel = exState.getValue(BlockPoweredFluidCrafter.FluidLevel);
			String fluidName = exState.getValue(BlockPoweredFluidCrafter.FluidName);
