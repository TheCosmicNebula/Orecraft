...
public class ContainerPoweredFurnace
  extends Container
{
  ...
  public ContainerPoweredFurnace(InventoryPlayer invPlayer, IInventory tile)
  {
    this.inventory = tile;
    for (int x = 0; x < 9; x++) {
    ...
    addSlotToContainer(new SlotFurnaceOutput(invPlayer.player, tile, 2, 116, 35));
