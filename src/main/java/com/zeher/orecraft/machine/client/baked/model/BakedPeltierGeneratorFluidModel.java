	...
	public BakedPeltierGeneratorFluidModel(Fluid fluid, int level) {
		...
		if (fluid.getTemperature() < 1000) {
			...
			for (int i = 0; i < 4; i++) {
				...
				putVertex(quadBuilder, side, Z, 0.5f + offset, X, texture.getInterpolatedU(z[i] * 16),
						texture.getInterpolatedV(x[i] * 16));
			}
			...
			putVertex(quadBuilder, side, x[2] - offset, y[2], z[2], texture.getInterpolatedU(0),
					texture.getInterpolatedV(16 - level));
			putVertex(quadBuilder, side, x[2] - offset, 0.5f + offset, z[2], texture.getInterpolatedU(0),
					texture.getInterpolatedV(16));
			putVertex(quadBuilder, side, x[3] - offset, 0.5f + offset, z[3], texture.getInterpolatedU(16),
					texture.getInterpolatedV(16));
			putVertex(quadBuilder, side, x[3] - offset, y[3], z[3], texture.getInterpolatedU(16),
					texture.getInterpolatedV(16 - level));
			...
			putVertex(quadBuilder, side, x[0] + offset, y[0], z[0], texture.getInterpolatedU(0),
					texture.getInterpolatedV(16 - level));
			putVertex(quadBuilder, side, x[0] + offset, 0.5f + offset, z[0], texture.getInterpolatedU(0),
					texture.getInterpolatedV(16));
			putVertex(quadBuilder, side, x[1] + offset, 0.5f + offset, z[1], texture.getInterpolatedU(16),
					texture.getInterpolatedV(16));
			putVertex(quadBuilder, side, x[1] + offset, y[1], z[1], texture.getInterpolatedU(16),
					texture.getInterpolatedV(16 - level));
			...
			putVertex(quadBuilder, side, x[1], y[1], z[1] - offset, texture.getInterpolatedU(0),
					texture.getInterpolatedV(16 - level));
			putVertex(quadBuilder, side, x[1], 0.5f + offset, z[1] - offset, texture.getInterpolatedU(0),
					texture.getInterpolatedV(16));
			putVertex(quadBuilder, side, x[2], 0.5f + offset, z[2] - offset, texture.getInterpolatedU(16),
					texture.getInterpolatedV(16));
			putVertex(quadBuilder, side, x[2], y[2], z[2] - offset, texture.getInterpolatedU(16),
					texture.getInterpolatedV(16 - level));
			...
			putVertex(quadBuilder, side, x[3], y[3], z[3] + offset, texture.getInterpolatedU(0),
					texture.getInterpolatedV(16 - level));
			putVertex(quadBuilder, side, x[3], 0.5f + offset, z[3] + offset, texture.getInterpolatedU(0),
					texture.getInterpolatedV(16));
			putVertex(quadBuilder, side, x[0], 0.5f + offset, z[0] + offset, texture.getInterpolatedU(16),
					texture.getInterpolatedV(16));
			putVertex(quadBuilder, side, x[0], y[0], z[0] + offset, texture.getInterpolatedU(16),
					texture.getInterpolatedV(16 - level));
