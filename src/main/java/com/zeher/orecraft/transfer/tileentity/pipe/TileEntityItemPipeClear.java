...
import com.zeher.trzlib.transfer.TRZTileEntityItemPipeClear;
...
public class TileEntityItemPipeClear
  extends TRZTileEntityItemPipeClear {
  ...
  public TRZItemPipeConnectionType getItemConnectionState(EnumFacing side)
  {
    ...
    TRZTileEntityItemPipeClear tile = (TRZTileEntityItemPipeClear)world.getTileEntity(pos);
    ...
    if(blockId.getBlock() instanceof TRZBlockItemPipe){
	    if(tileOther != null && tileOther instanceof TRZTileEntityItemPipeClear){
	    	if(side.equals(EnumFacing.UP) && (this.up == 2 || this.up == 0)){
	    		if(((TRZTileEntityItemPipeClear)tileOther).getSide("down") == 1){
	    			return TRZItemPipeConnectionType.none;
	    		} else {
	    	...
	    	if(side.equals(EnumFacing.DOWN) && (this.down == 2 || this.down == 0)){
	    		if(((TRZTileEntityItemPipeClear)tileOther).getSide("up") == 1){
	    			return TRZItemPipeConnectionType.none;
	    		} else {
	    			return TRZItemPipeConnectionType.cableall;
	    		}
	    	...
	    	if(side.equals(EnumFacing.NORTH) && (this.north == 2 || this.north == 0)){
	    		if(((TRZTileEntityItemPipeClear)tileOther).getSide("south") == 1){
	    			return TRZItemPipeConnectionType.none;
	    		} else {
	    			return TRZItemPipeConnectionType.cableall;
	    		}
	    	...
	    	if(side.equals(EnumFacing.SOUTH) && (this.south == 2 || this.south == 0)){
	    		if(((TRZTileEntityItemPipeClear)tileOther).getSide("north") == 1){
	    			return TRZItemPipeConnectionType.none;
	    		} else {
	    			return TRZItemPipeConnectionType.cableall;
	    		}
	    	...
	    	if(side.equals(EnumFacing.EAST) && (this.east == 2 || this.east == 0)){
	    		if(((TRZTileEntityItemPipeClear)tileOther).getSide("west") == 1){
	    			return TRZItemPipeConnectionType.none;
	    		} else {
	    			return TRZItemPipeConnectionType.cableall;
	    		}
	    	...
	    	if(side.equals(EnumFacing.WEST) && (this.west == 2 || this.west == 0)){
	    		if(((TRZTileEntityItemPipeClear)tileOther).getSide("east") == 1){
	    			return TRZItemPipeConnectionType.none;
	    		} else {
	    			return TRZItemPipeConnectionType.cableall;
	    		}
