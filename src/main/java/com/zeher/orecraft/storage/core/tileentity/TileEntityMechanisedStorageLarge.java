...
public class TileEntityMechanisedStorageLarge extends TileEntity implements IInventory, ISidedInventory {
	...
	private NonNullList<ItemStack> storage_stacks = NonNullList.<ItemStack>withSize(100, ItemStack.EMPTY);
	...
	public String getName() {
		return this.hasCustomName() ? this.custom_name : OrecraftReference.GUI_NAME.STORAGE.MECHANISEDSTORAGELARGE;
	}
