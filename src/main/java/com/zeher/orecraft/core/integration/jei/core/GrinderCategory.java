...
public class GrinderCategory extends BlankRecipeCategory {
	...
	private final ResourceLocation gui = new ResourceLocation(OrecraftReference.RESOURCE.GUI + "machine/powered/grinder/gui_grinder.png");
	
	public GrinderCategory(IGuiHelper helper) {
		loc_title = I18n.format(OrecraftReference.JEI.GRINDER_UNLOC);
		
		background = helper.createDrawable(new ResourceLocation(OrecraftReference.RESOURCE.GUI + "machine/powered/grinder/gui_grinder_jei.png"), 0, 0, 78, 72);
		
		IDrawableStatic process_draw = helper.createDrawable(gui, 176, 0, 16, 16);
		IDrawableStatic stored_draw = helper.createDrawable(gui, 176, 16, 18, 40);
	...
	public String getUid() {
		return OrecraftReference.JEI.GRINDER_UID;
	}
	...
	public void setRecipe(IRecipeLayout recipeLayout, IRecipeWrapper recipeWrapper, IIngredients ingredients) {
		if (!(recipeWrapper instanceof GrinderRecipe)) {
			return;
		}
