...
public class TileEntityPoweredEnergyPipe extends TileEntity implements ITickable, IInventory, IEnergyPipe {

	private NonNullList<ItemStack> pipe_stacks = NonNullList.<ItemStack>withSize(6, ItemStack.EMPTY);

	public int stored;
	public int capacity = Reference.VALUE.ENERGYPIPE.POWERED_CAPACITY;
	public int transfer_rate = Reference.VALUE.ENERGYPIPE.POWERED_TRANSFER;
