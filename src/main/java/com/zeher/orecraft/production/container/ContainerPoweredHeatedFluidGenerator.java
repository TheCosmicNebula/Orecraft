...
public class ContainerPoweredHeatedFluidGenerator extends Container {
	...
	public ContainerPoweredHeatedFluidGenerator(InventoryPlayer invPlayer, IInventory tile) {
		this.inventory = tile;
		...
		addSlotToContainer(new SlotBucket(tile, 7, 104, 17));
		addSlotToContainer(new SlotRestrictedAccess(tile, 8, 104, 61, 22));
