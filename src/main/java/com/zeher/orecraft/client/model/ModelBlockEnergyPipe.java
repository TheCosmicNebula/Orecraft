...
public class ModelBlockEnergyPipe extends ModelBase {
	...
	public ModelBlockEnergyPipe() {
		...
		this._interfaceConn.addBox(3.0F, -3.0F, -3.0F, 8, 6, 6);
	...
	public void render(float f5) {
		this._base.render(f5);
		renderSide(TRZEnergyPipeConnectionType.cableall, 0.0F, 0.0F, f5);
		renderSide(TRZEnergyPipeConnectionType.cableall, 3.1415927F, 0.0F, f5);
	}

	public void render(TRZTileEntityEnergyPipe entity, float f5) {
		if ((entity.getEnergyConnectionState(EnumFacing.UP) == TRZEnergyPipeConnectionType.cableall
				&& entity.getEnergyConnectionState(EnumFacing.DOWN) == TRZEnergyPipeConnectionType.cableall)
				&& ((entity.getEnergyConnectionState(EnumFacing.EAST) == TRZEnergyPipeConnectionType.cableall
				|| entity.getEnergyConnectionState(EnumFacing.WEST) == TRZEnergyPipeConnectionType.cableall)
				|| (entity.getEnergyConnectionState(EnumFacing.NORTH) == TRZEnergyPipeConnectionType.cableall
				|| entity.getEnergyConnectionState(EnumFacing.SOUTH) == TRZEnergyPipeConnectionType.cableall))) {
			this._base.render(f5);
		}

		else if (entity.getEnergyConnectionState(EnumFacing.UP) == TRZEnergyPipeConnectionType.cableall
				&& entity.getEnergyConnectionState(EnumFacing.DOWN) == TRZEnergyPipeConnectionType.cableall
				&& !(entity.getEnergyConnectionState(EnumFacing.NORTH) == TRZEnergyPipeConnectionType.cablesingle) 
				&& !(entity.getEnergyConnectionState(EnumFacing.SOUTH) == TRZEnergyPipeConnectionType.cablesingle) 
				&& !(entity.getEnergyConnectionState(EnumFacing.EAST) == TRZEnergyPipeConnectionType.cablesingle)
				&& !(entity.getEnergyConnectionState(EnumFacing.WEST) == TRZEnergyPipeConnectionType.cablesingle)) {
			this._basevert.render(f5);
		}

		else if ((entity.getEnergyConnectionState(EnumFacing.EAST) == TRZEnergyPipeConnectionType.cableall
				&& entity.getEnergyConnectionState(EnumFacing.WEST) == TRZEnergyPipeConnectionType.cableall)
				&& ((entity.getEnergyConnectionState(EnumFacing.NORTH) == TRZEnergyPipeConnectionType.cableall
				|| entity.getEnergyConnectionState(EnumFacing.SOUTH) == TRZEnergyPipeConnectionType.cableall)
				|| (entity.getEnergyConnectionState(EnumFacing.UP) == TRZEnergyPipeConnectionType.cableall
				|| entity.getEnergyConnectionState(EnumFacing.DOWN) == TRZEnergyPipeConnectionType.cableall))) {
			this._base.render(f5);
		}

		else if (((entity.getEnergyConnectionState(EnumFacing.NORTH) == TRZEnergyPipeConnectionType.cableall
				&& entity.getEnergyConnectionState(EnumFacing.SOUTH) == TRZEnergyPipeConnectionType.cableall))
				&& (entity.getEnergyConnectionState(EnumFacing.EAST) == TRZEnergyPipeConnectionType.cableall
			    || entity.getEnergyConnectionState(EnumFacing.WEST) == TRZEnergyPipeConnectionType.cableall)
				|| (entity.getEnergyConnectionState(EnumFacing.UP) == TRZEnergyPipeConnectionType.cableall
			...
			this._base.render(f5);
				...
				&& !(entity.getEnergyConnectionState(EnumFacing.NORTH) == TRZEnergyPipeConnectionType.cablesingle) 
				&& !(entity.getEnergyConnectionState(EnumFacing.SOUTH) == TRZEnergyPipeConnectionType.cablesingle) 
				&& !(entity.getEnergyConnectionState(EnumFacing.UP) == TRZEnergyPipeConnectionType.cablesingle)
				&& !(entity.getEnergyConnectionState(EnumFacing.DOWN) == TRZEnergyPipeConnectionType.cablesingle)) {
		...
		renderSide(entity.getEnergyConnectionState(EnumFacing.EAST), 0.0F, 0.0F, f5);
		renderSide(entity.getEnergyConnectionState(EnumFacing.SOUTH), -1.5707964F, 0.0F, f5);
		renderSide(entity.getEnergyConnectionState(EnumFacing.WEST), 3.1415927F, 0.0F, f5);
		renderSide(entity.getEnergyConnectionState(EnumFacing.NORTH), 1.5707964F, 0.0F, f5);
		renderSide(entity.getEnergyConnectionState(EnumFacing.UP), 0.0F, 1.5707964F, f5);
		renderSide(entity.getEnergyConnectionState(EnumFacing.DOWN), 0.0F, -1.5707964F, f5);
	}

	private void renderSide(TRZEnergyPipeConnectionType state, float yRot, float zRot, float scale) {
		renderModelState(state, yRot, zRot, scale);
	}

	private void renderModelState(TRZEnergyPipeConnectionType state, float yRot, float zRot, float scale) {
		if (state.equals(TRZEnergyPipeConnectionType.cableall)) {
			this._cableConn.rotateAngleY = yRot;
			this._cableConn.rotateAngleZ = zRot;
			this._cableConn.render(scale);
		}
		if (state.equals(TRZEnergyPipeConnectionType.cablesingle)) {
			this._interfaceConn.rotateAngleY = yRot;
			this._interfaceConn.rotateAngleZ = zRot;
			this._interfaceConn.render(scale);
		}
		if (state.equals(TRZEnergyPipeConnectionType.support)) {
