...
public class BlockEnergizedGrinder extends TRZBlockMachine{
	...
	public BlockEnergizedGrinder(Material material, String name, String tool, int harvest, int hardness, int resistance, CreativeTabs tab, boolean isBurning) {
    ...
    {
        return Item.getItemFromBlock(BlockHandler.block_energized_grinder);
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, BlockHandler.block_energized_grinder_on.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, BlockHandler.block_energized_grinder_on.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
            worldIn.setBlockState(pos, BlockHandler.block_energized_grinder.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, BlockHandler.block_energized_grinder.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            if (tileentity instanceof TileEntityEnergizedGrinder)
            {
                ((TileEntityEnergizedGrinder)tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        if (!keepInventory)
        {
            ...
            if (tileentity instanceof TileEntityEnergizedGrinder)
            {
                InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityEnergizedGrinder)tileentity);
    ...
    {
        return new ItemStack(BlockHandler.block_energized_grinder);
    }
