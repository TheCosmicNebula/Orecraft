...
public class BlockPoweredCharger extends BlockMachine {

	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	private static boolean keepInventory;

	public BlockPoweredCharger(Material material, String name, String tool, int harvest, int hardness, int resistance, CreativeTabs tab) {
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(BlockHandler.REGISTRATION.MACHINE.BLOCK_POWERED_CHARGER);
	}
	...
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(BlockHandler.REGISTRATION.MACHINE.BLOCK_POWERED_CHARGER);
	}
