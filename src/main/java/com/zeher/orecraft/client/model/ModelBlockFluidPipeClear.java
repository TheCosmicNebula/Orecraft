...
import com.zeher.trzlib.transfer.TRZTileEntityFluidPipeClear;
...
public class ModelBlockFluidPipeClear extends ModelBase {
	...
	public ModelBlockFluidPipeClear() {
	...
	public void render(float f5) {
		this._base.render(f5);
		renderSide(TRZFluidPipeConnectionType.cableall, 0.0F, 0.0F, f5);
		renderSide(TRZFluidPipeConnectionType.cableall, 3.1415927F, 0.0F, f5);
	}

	public void render(TRZTileEntityFluidPipeClear entity, float f5) {
		if ((entity.getFluidConnectionState(EnumFacing.UP) == TRZFluidPipeConnectionType.cableall
				&& entity.getFluidConnectionState(EnumFacing.DOWN) == TRZFluidPipeConnectionType.cableall)
				&& ((entity.getFluidConnectionState(EnumFacing.EAST) == TRZFluidPipeConnectionType.cableall
				|| entity.getFluidConnectionState(EnumFacing.WEST) == TRZFluidPipeConnectionType.cableall)
				|| (entity.getFluidConnectionState(EnumFacing.NORTH) == TRZFluidPipeConnectionType.cableall
				|| entity.getFluidConnectionState(EnumFacing.SOUTH) == TRZFluidPipeConnectionType.cableall))) {
			this._base.render(f5);
		}

		else if (entity.getFluidConnectionState(EnumFacing.UP) == TRZFluidPipeConnectionType.cableall
				&& entity.getFluidConnectionState(EnumFacing.DOWN) == TRZFluidPipeConnectionType.cableall
				&& !(entity.getFluidConnectionState(EnumFacing.NORTH) == TRZFluidPipeConnectionType.cablesingle) 
				&& !(entity.getFluidConnectionState(EnumFacing.SOUTH) == TRZFluidPipeConnectionType.cablesingle) 
				&& !(entity.getFluidConnectionState(EnumFacing.EAST) == TRZFluidPipeConnectionType.cablesingle)
				&& !(entity.getFluidConnectionState(EnumFacing.WEST) == TRZFluidPipeConnectionType.cablesingle)) {
			this._basevert.render(f5);
		}

		else if ((entity.getFluidConnectionState(EnumFacing.EAST) == TRZFluidPipeConnectionType.cableall
				&& entity.getFluidConnectionState(EnumFacing.WEST) == TRZFluidPipeConnectionType.cableall)
				&& ((entity.getFluidConnectionState(EnumFacing.NORTH) == TRZFluidPipeConnectionType.cableall
				|| entity.getFluidConnectionState(EnumFacing.SOUTH) == TRZFluidPipeConnectionType.cableall)
				|| (entity.getFluidConnectionState(EnumFacing.UP) == TRZFluidPipeConnectionType.cableall
				|| entity.getFluidConnectionState(EnumFacing.DOWN) == TRZFluidPipeConnectionType.cableall))) {
			this._base.render(f5);
		}

		else if (((entity.getFluidConnectionState(EnumFacing.NORTH) == TRZFluidPipeConnectionType.cableall
				&& entity.getFluidConnectionState(EnumFacing.SOUTH) == TRZFluidPipeConnectionType.cableall))
				&& (entity.getFluidConnectionState(EnumFacing.EAST) == TRZFluidPipeConnectionType.cableall
			    || entity.getFluidConnectionState(EnumFacing.WEST) == TRZFluidPipeConnectionType.cableall)
				|| (entity.getFluidConnectionState(EnumFacing.UP) == TRZFluidPipeConnectionType.cableall
			...
			this._base.render(f5);
				...
				&& !(entity.getFluidConnectionState(EnumFacing.NORTH) == TRZFluidPipeConnectionType.cablesingle) 
				&& !(entity.getFluidConnectionState(EnumFacing.SOUTH) == TRZFluidPipeConnectionType.cablesingle) 
				&& !(entity.getFluidConnectionState(EnumFacing.UP) == TRZFluidPipeConnectionType.cablesingle)
				&& !(entity.getFluidConnectionState(EnumFacing.DOWN) == TRZFluidPipeConnectionType.cablesingle)) {
		...
		renderSide(entity.getFluidConnectionState(EnumFacing.EAST), 0.0F, 0.0F, f5);
		renderSide(entity.getFluidConnectionState(EnumFacing.SOUTH), -1.5707964F, 0.0F, f5);
		renderSide(entity.getFluidConnectionState(EnumFacing.WEST), 3.1415927F, 0.0F, f5);
		renderSide(entity.getFluidConnectionState(EnumFacing.NORTH), 1.5707964F, 0.0F, f5);
		renderSide(entity.getFluidConnectionState(EnumFacing.UP), 0.0F, 1.5707964F, f5);
		renderSide(entity.getFluidConnectionState(EnumFacing.DOWN), 0.0F, -1.5707964F, f5);
	}

	private void renderSide(TRZFluidPipeConnectionType state, float yRot, float zRot, float scale) {
		renderModelState(state, yRot, zRot, scale);
	}

	private void renderModelState(TRZFluidPipeConnectionType state, float yRot, float zRot, float scale) {
		if (state.equals(TRZFluidPipeConnectionType.cableall)) {
			this._cableConn.rotateAngleY = yRot;
			this._cableConn.rotateAngleZ = zRot;
			this._cableConn.render(scale);
		}
		if (state.equals(TRZFluidPipeConnectionType.cablesingle)) {
			this._interfaceConn.rotateAngleY = yRot;
			this._interfaceConn.rotateAngleZ = zRot;
			this._interfaceConn.render(scale);
		}
		if (state.equals(TRZFluidPipeConnectionType.support)) {
