...
public class BakedPeltierGeneratorModel implements IBakedModel
{
	...
	public List<BakedQuad> getQuads(IBlockState state, EnumFacing side, long rand)
	{
		...
		else if (MinecraftForgeClient.getRenderLayer() == BlockRenderLayer.TRANSLUCENT)
		{
			...
			boolean cullFluidTop = exState.getValue(BlockPeltierGeneratorBasic.CullFluidTop);
			int fluidLevel = exState.getValue(BlockPeltierGeneratorBasic.FluidLevel);
			String fluidName = exState.getValue(BlockPeltierGeneratorBasic.FluidName);
			
			int fluidLevel_two = exState.getValue(BlockPeltierGeneratorBasic.FluidLevel_two);
			String fluidName_two = exState.getValue(BlockPeltierGeneratorBasic.FluidName_two);
