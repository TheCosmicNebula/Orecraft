...
public class ContainerPeltierGeneratorBasic extends Container {
	...
	public ContainerPeltierGeneratorBasic(InventoryPlayer invPlayer, IInventory tile) {
		this.inventory = tile;
		for (int x = 0; x < 9; x++) {
		...
		addSlotToContainer(new TRZSlotBucket(tile, 7, 86, 8));
		addSlotToContainer(new TRZSlotNoAccess(tile, 8, 86, 52, 16));
	}
