...
public class ItemBlockEnergizedCapacitor extends ItemBlock {
	...
	public int max_power = Reference.VALUE.STORAGE.ENERGIZED_CAPACITY / 1000;
	...
	public boolean placeBlockAt(ItemStack stack, EntityPlayer player, World world, BlockPos pos, EnumFacing side,
		...
		if (stack.hasTagCompound()) {
			TileEntityEnergizedCapacitor tile = (TileEntityEnergizedCapacitor) world.getTileEntity(pos);
