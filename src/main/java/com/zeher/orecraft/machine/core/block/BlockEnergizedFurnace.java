...
public class BlockEnergizedFurnace extends BlockMachine {

	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	private static boolean keepInventory;

	public BlockEnergizedFurnace(Material material, String name, String tool, int harvest, int hardness, int resistance, CreativeTabs tab) {
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(BlockHandler.REGISTRATION.MACHINE.BLOCK_ENERGIZED_FURNACE);
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (!(worldIn.isRemote) && !(playerIn.isSneaking()) && !(ModUtil.isHoldingHammer(playerIn))) {
			FMLNetworkHandler.openGui(playerIn, Orecraft.INSTANCE, 15, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
		return true;
	}
	...
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(BlockHandler.REGISTRATION.MACHINE.BLOCK_ENERGIZED_FURNACE);
	}
