...
public class BlockEnergizedEnergyPipe extends TRZBlockEnergyPipe {
	...
	public BlockEnergizedEnergyPipe(String name, Material material, String tool, int harvest, int hardness, int resistance, CreativeTabs tab) {
	...
	public TileEntity createNewTileEntity(World arg0, int arg1) {
		return new TileEntityEnergizedEnergyPipe();
	}
	...
	public boolean getSide(EnumFacing side, World world, BlockPos pos){
		...
		int downInt = 0;
		int upInt = 0;
		if(tile != null && tile instanceof TileEntityEnergizedEnergyPipe){
			northInt = ((TileEntityEnergizedEnergyPipe) tile).getSide("north");
			eastInt = ((TileEntityEnergizedEnergyPipe) tile).getSide("east");
			southInt = ((TileEntityEnergizedEnergyPipe) tile).getSide("south");
			westInt = ((TileEntityEnergizedEnergyPipe) tile).getSide("west");
			downInt = ((TileEntityEnergizedEnergyPipe) tile).getSide("down");
			upInt = ((TileEntityEnergizedEnergyPipe) tile).getSide("up");
		} else {
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
		...
		TileEntityEnergizedEnergyPipe tile = (TileEntityEnergizedEnergyPipe) world.getTileEntity(pos);
		if ((tile instanceof TileEntityEnergizedEnergyPipe) && tile != null) {
