...
public class BlockFluidPipeSolid extends TRZBlockFluidPipe {
	...
	public BlockFluidPipeSolid(String name, Material material, String tool, int harvest, int hardness, int resistance, CreativeTabs tab) {
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
    {
		...
		if(tile != null && tile instanceof TileEntityFluidPipeSolid){
			northInt = ((TileEntityFluidPipeSolid) tile).getSide("north");
			eastInt = ((TileEntityFluidPipeSolid) tile).getSide("east");
			southInt = ((TileEntityFluidPipeSolid) tile).getSide("south");
			westInt = ((TileEntityFluidPipeSolid) tile).getSide("west");
			downInt = ((TileEntityFluidPipeSolid) tile).getSide("down");
			upInt = ((TileEntityFluidPipeSolid) tile).getSide("up");
		} else {
