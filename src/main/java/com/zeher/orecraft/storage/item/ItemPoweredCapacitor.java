...
public class ItemPoweredCapacitor extends TRZItemStorage {

	public static int maxPower;

	public ItemPoweredCapacitor(String name, int maxPower, CreativeTabs tab) {
	...
	public void addInformation(ItemStack item, EntityPlayer player, List list, boolean bool) {
		...
		if (TRZTextUtil.isShiftKeyDown()) {
			list.add(TRZTextUtil.getFlavorText("Current Power: ") + TRZTextUtil.ORANGE + ((maxPower - item.getItemDamage())) * 10000);
