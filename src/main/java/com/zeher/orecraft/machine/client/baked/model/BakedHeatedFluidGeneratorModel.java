...
public class BakedHeatedFluidGeneratorModel implements IBakedModel {
	...
	public BakedHeatedFluidGeneratorModel(IBakedModel baseModel) {
	...
	public List<BakedQuad> getQuads(IBlockState state, EnumFacing side, long rand) {
		...
		if (MinecraftForgeClient.getRenderLayer() == BlockRenderLayer.CUTOUT_MIPPED) {
			...
			boolean cullFluidTop = exState.getValue(BlockPoweredHeatedFluidGenerator.CullFluidTop);
			int fluidLevel = exState.getValue(BlockPoweredHeatedFluidGenerator.FluidLevel);
			String fluidName = exState.getValue(BlockPoweredHeatedFluidGenerator.FluidName);
