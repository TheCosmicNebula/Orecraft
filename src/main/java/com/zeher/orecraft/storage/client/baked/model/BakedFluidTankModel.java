package com.zeher.orecraft.storage.client.baked.model;
...
public class BakedFluidTankModel implements IBakedModel {
	...
	public BakedFluidTankModel(IBakedModel baseModel) {
	...
	public List<BakedQuad> getQuads(IBlockState state, EnumFacing side, long rand) {
		...
		if (MinecraftForgeClient.getRenderLayer() == BlockRenderLayer.CUTOUT_MIPPED) {
			...
			boolean cullFluidTop = exState.getValue(BlockFluidTank.CullFluidTop);
			int fluidLevel = exState.getValue(BlockFluidTank.FluidLevel);
			String fluidName = exState.getValue(BlockFluidTank.FluidName);
