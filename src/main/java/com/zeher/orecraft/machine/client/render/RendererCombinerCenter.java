...
public class RendererCombinerCenter extends TileEntitySpecialRenderer {
	public void func_180535_a(TileEntity tileentity, double x, double y, double z, float partialTicks, int destroyStage) {
		if(tileentity == null) {
			return;
		}
		...
		TileEntityCombinerCenter tile = (TileEntityCombinerCenter) tileentity;
