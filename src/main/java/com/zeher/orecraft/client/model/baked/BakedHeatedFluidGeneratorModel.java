...
public class BakedHeatedFluidGeneratorModel implements IBakedModel
{
	...
	public List<BakedQuad> getQuads(IBlockState state, EnumFacing side, long rand)
	{
		...
		else if (MinecraftForgeClient.getRenderLayer() == BlockRenderLayer.TRANSLUCENT)
		{
			...
			boolean cullFluidTop = exState.getValue(BlockHeatedFluidGeneratorBasic.CullFluidTop);
			int fluidLevel = exState.getValue(BlockHeatedFluidGeneratorBasic.FluidLevel);
			String fluidName = exState.getValue(BlockHeatedFluidGeneratorBasic.FluidName);
