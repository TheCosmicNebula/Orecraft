...
public class TileEntityEnergizedEnergyPipe extends TRZTileEntityEnergyPipe
	...
	public int stored;
	public int capacity = TRZEnergyPipeValues.capacityEnder();
	public int transfer_rate = TRZEnergyPipeValues.transferRateEnder();
	...
	public void update() {
		...
		if (block instanceof BlockEnergizedEnergyPipe) {
			boolean up = ((BlockEnergizedEnergyPipe) block).getSide(EnumFacing.UP, world, this.pos);
			boolean down = ((BlockEnergizedEnergyPipe) block).getSide(EnumFacing.DOWN, world, pos);
			boolean east = ((BlockEnergizedEnergyPipe) block).getSide(EnumFacing.EAST, world, this.pos);
			boolean west = ((BlockEnergizedEnergyPipe) block).getSide(EnumFacing.WEST, world, pos);
			boolean north = ((BlockEnergizedEnergyPipe) block).getSide(EnumFacing.NORTH, world, this.pos);
			boolean south = ((BlockEnergizedEnergyPipe) block).getSide(EnumFacing.SOUTH, world, pos);
			...
			if (this_tile != null) {
					...
					if (tile_up instanceof TRZTileEntityEnergyPipe) {
						if (this.last_from != null) {
							if (this.last_from.equals(EnumFacing.UP)) {
								if (((TRZTileEntityEnergyPipe) tile_up).getSide("down") == 0 || ((TRZTileEntityEnergyPipe) tile_up).getSide("down") == 2) {
									...
									if (pipe_stored <= pipe_capacity) {
										if(pipe_transfer_rate <= this.transfer_rate){
											...
											if (gap_stored >= this.transfer_rate) {
												...
												((TRZTileEntityEnergyPipe) tile_up).addStored(this.transfer_rate, EnumFacing.UP);
					...
					if (tile_down instanceof TRZTileEntityEnergyPipe) {
						if (this.last_from != null) {
							if (this.last_from.equals(EnumFacing.DOWN)) {
								if (((TRZTileEntityEnergyPipe) tile_down).getSide("up") == 0 || ((TRZTileEntityEnergyPipe) tile_down).getSide("up") == 2) {
									...
									if (pipe_stored <= pipe_capacity) {
										if(pipe_transfer_rate <= this.transfer_rate){
											...
											if (gap_stored >= this.transfer_rate) {
												this.stored -= this.transfer_rate;
												((TRZTileEntityEnergyPipe) tile_down).addStored(this.transfer_rate, EnumFacing.DOWN);
											} else if (gap_stored < this.transfer_rate) {
												this.stored -= gap_stored;
												((TRZTileEntityEnergyPipe) tile_down).addStored(gap_stored, EnumFacing.DOWN);
											}
				...
				if (tile_north != null && (this.north == 0 || this.north == 2)) {
					if (tile_north instanceof TRZTileEntityEnergyPipe) {
						if (this.last_from != null) {
							if (this.last_from.equals(EnumFacing.NORTH)) {
								if (((TRZTileEntityEnergyPipe) tile_north).getSide("south") == 0 || ((TRZTileEntityEnergyPipe) tile_north).getSide("south") == 2) {
									...
									if (pipe_stored <= pipe_capacity) {
										if(pipe_transfer_rate <= this.transfer_rate){
											...
											if (gap_stored >= this.transfer_rate) {
												this.stored -= this.transfer_rate;
												((TRZTileEntityEnergyPipe) tile_north).addStored(this.transfer_rate, EnumFacing.NORTH);
											} else if (gap_stored < this.transfer_rate) {
												this.stored -= gap_stored;
												((TRZTileEntityEnergyPipe) tile_north).addStored(gap_stored, EnumFacing.NORTH);
											}
				...
				if (tile_south != null && (this.south == 0 || this.south == 2)) {
					if (tile_south instanceof TRZTileEntityEnergyPipe) {
						if (this.last_from != null) {
							if (this.last_from.equals(EnumFacing.SOUTH)) {
								if (((TRZTileEntityEnergyPipe) tile_south).getSide("north") == 0 || ((TRZTileEntityEnergyPipe) tile_south).getSide("north") == 2) {
									...
									if (pipe_stored <= pipe_capacity) {
										if(pipe_transfer_rate <= this.transfer_rate){
											...
											if (gap_stored >= this.transfer_rate) {
												this.stored -= this.transfer_rate;
												((TRZTileEntityEnergyPipe) tile_south).addStored(this.transfer_rate, EnumFacing.SOUTH);
											} else if (gap_stored < this.transfer_rate) {
												this.stored -= gap_stored;
												((TRZTileEntityEnergyPipe) tile_south).addStored(gap_stored, EnumFacing.SOUTH);
											}
				...
				if (tile_west != null && (this.west == 0 || this.west == 2)) {
					if (tile_west instanceof TRZTileEntityEnergyPipe) {
						if (this.last_from != null) {
							if (this.last_from.equals(EnumFacing.WEST)) {
								if (((TRZTileEntityEnergyPipe) tile_west).getSide("east") == 0 || ((TRZTileEntityEnergyPipe) tile_west).getSide("east") == 2) {
									...
									if (pipe_stored <= pipe_capacity) {
										if(pipe_transfer_rate <= this.transfer_rate){
											...
											if (gap_stored >= this.transfer_rate) {
												this.stored -= this.transfer_rate;
												((TRZTileEntityEnergyPipe) tile_west).addStored(this.transfer_rate, EnumFacing.WEST);
											} else if (gap_stored < this.transfer_rate) {
												this.stored -= gap_stored;
												((TRZTileEntityEnergyPipe) tile_west).addStored(gap_stored, EnumFacing.WEST);
											}
				...
				if (tile_east != null && (this.east == 0 || this.east == 2)) {
					if (tile_east instanceof TRZTileEntityEnergyPipe) {
						if (this.last_from != null) {
							if (this.last_from.equals(EnumFacing.EAST)) {
								if (((TRZTileEntityEnergyPipe) tile_east).getSide("west") == 0 || ((TRZTileEntityEnergyPipe) tile_east).getSide("west") == 2) {
									...
									if (pipe_stored <= pipe_capacity) {
										if(pipe_transfer_rate <= this.transfer_rate){
											...
											if (gap_stored >= this.transfer_rate) {
												this.stored -= this.transfer_rate;
												((TRZTileEntityEnergyPipe) tile_east).addStored(this.transfer_rate, EnumFacing.EAST);
											} else if (gap_stored < this.transfer_rate) {
												this.stored -= gap_stored;
												((TRZTileEntityEnergyPipe) tile_east).addStored(gap_stored, EnumFacing.EAST);
											}
	...
	public TRZEnergyPipeConnectionType getEnergyConnectionState(EnumFacing side) {
		...
		if(blockId instanceof TRZBlockCapacitor){
			return TRZEnergyPipeConnectionType.cablesingle;
		}
