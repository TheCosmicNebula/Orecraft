...
public class BlockCoalGeneratorBasic extends TRZBlockProducer {
	...
	public BlockCoalGeneratorBasic(String name, Material material, String tool, int harvest, int hardness, int resistance, CreativeTabs tab, boolean isBurning) {
    ...
    {
        return Item.getItemFromBlock(BlockHandler.block_coalgenerator);
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
    	if(!(worldIn.isRemote) && !(playerIn.isSneaking()) && !(TRZUtil.isHoldingHammer(playerIn))){
			FMLNetworkHandler.openGui(playerIn, OreCraft.instance, 44, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
    	return true;
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, BlockHandler.block_coalgenerator_on.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, BlockHandler.block_coalgenerator_on.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
            worldIn.setBlockState(pos, BlockHandler.block_coalgenerator.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, BlockHandler.block_coalgenerator.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    {
        return new TileEntityCoalGeneratorBasic();
    }
    ...
    {
        return new ItemStack(BlockHandler.block_coalgenerator);
    }
