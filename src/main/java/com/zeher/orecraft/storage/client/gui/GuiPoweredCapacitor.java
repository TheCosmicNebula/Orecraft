...
import com.zeher.orecraft.storage.core.container.ContainerPoweredCapacitor;
...
public class GuiPoweredCapacitor extends GuiContainer {
	...
	private TileEntityPoweredCapacitor INVENTORY;
	...
	protected void drawGuiContainerForegroundLayer(int mouse_x, int mouse_y) {
		...
		this.fontRenderer.drawString(s, this.xSize / 2 - this.fontRenderer.getStringWidth(s) / 2 - 27, 5, 4210752);
		this.fontRenderer.drawString(I18n.format("container.inventory"), 7, this.ySize - 92, 4210752);
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
		...
		if (this.INVENTORY.hasStored()) {
			...
			int[] bar_location = Reference.GUI.ENERGY_BAR_INFO.POWERED_BAR;
