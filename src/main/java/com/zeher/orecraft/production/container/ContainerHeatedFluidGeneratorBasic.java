...
public class ContainerHeatedFluidGeneratorBasic extends Container {
	...
	public ContainerHeatedFluidGeneratorBasic(InventoryPlayer invPlayer, IInventory tile) {
		this.inventory = tile;
		for (int x = 0; x < 9; x++) {
		...
		addSlotToContainer(new TRZSlotMachineUpgrade(tile, 4, 152, 8, ItemHandler.upgrade_fluid_speed));
		addSlotToContainer(new TRZSlotMachineUpgrade(tile, 5, 152, 30, ItemHandler.upgrade_fluid_capacity));
		addSlotToContainer(new TRZSlotMachineUpgrade(tile, 6, 152, 52, ItemHandler.upgrade_fluid_efficiency));
		
		addSlotToContainer(new TRZSlotBucket(tile, 7, 108, 8));
		addSlotToContainer(new TRZSlotNoAccess(tile, 8, 108, 52, 16));
	}
