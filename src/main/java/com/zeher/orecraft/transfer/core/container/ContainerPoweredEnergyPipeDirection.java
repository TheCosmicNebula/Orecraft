package com.zeher.orecraft.transfer.core.container;
...
public class ContainerPoweredEnergyPipeDirection extends Container {
	private IInventory capacitor;
	private int power;

	public ContainerPoweredEnergyPipeDirection(InventoryPlayer invPlayer, IInventory tile) {
		this.capacitor = tile;
		addSlotToContainer(new SlotFake(tile, 0, 11, 16));
		addSlotToContainer(new SlotFake(tile, 1, 123, 16));
		addSlotToContainer(new SlotFake(tile, 2, 11, 46));
		addSlotToContainer(new SlotFake(tile, 3, 123, 46));
		addSlotToContainer(new SlotFake(tile, 4, 11, 76));
		addSlotToContainer(new SlotFake(tile, 5, 123, 76));
