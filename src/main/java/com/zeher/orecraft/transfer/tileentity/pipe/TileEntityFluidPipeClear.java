...
public class TileEntityFluidPipeClear extends TRZTileEntityFluidPipeClear implements IFluidHandler, ITickable {
	...
	public TRZFluidPipeConnectionType getFluidConnectionState(EnumFacing side) {
		...
		TRZTileEntityFluidPipe tile = (TRZTileEntityFluidPipe) world.getTileEntity(pos);
		...
		if (blockId.getBlock() instanceof TRZBlockFluidPipe) {
			if (tileOther != null && tileOther instanceof TRZTileEntityFluidPipe) {
				if (side.equals(EnumFacing.UP) && (this.up == 2 || this.up == 0)) {
					if (((TRZTileEntityFluidPipe) tileOther).getSide("down") == 1) {
						return TRZFluidPipeConnectionType.none;
					}
					if(tank.getFluidAmount() == 0 && ((TRZTileEntityFluidPipe)tileOther).getTank().getFluid() != null){
						return TRZFluidPipeConnectionType.none;
					}
					if (tank.getFluid() != null) {
						if (((TRZTileEntityFluidPipe) tileOther).getTank().getFluid() != null) {
							if (((TRZTileEntityFluidPipe) tileOther).getTank().getFluid().getFluid().getName().equals(tank.getFluid().getFluid().getName())) {
				...
				if (side.equals(EnumFacing.DOWN) && (this.down == 2 || this.down == 0)) {
					if (((TRZTileEntityFluidPipe) tileOther).getSide("up") == 1) {
						return TRZFluidPipeConnectionType.none;
					}
					if(tank.getFluidAmount() == 0 && ((TRZTileEntityFluidPipe)tileOther).getTank().getFluid() != null){
						return TRZFluidPipeConnectionType.none;
				...
				if (side.equals(EnumFacing.NORTH) && (this.north == 2 || this.north == 0)) {
					if (((TRZTileEntityFluidPipe) tileOther).getSide("south") == 1) {
						return TRZFluidPipeConnectionType.none;
					} 
					if(tank.getFluidAmount() == 0 && ((TRZTileEntityFluidPipe)tileOther).getTank().getFluid() != null){
						return TRZFluidPipeConnectionType.none;
				...
				if (side.equals(EnumFacing.SOUTH) && (this.south == 2 || this.south == 0)) {
					if (((TRZTileEntityFluidPipe) tileOther).getSide("north") == 1) {
						return TRZFluidPipeConnectionType.none;
					}
					if(tank.getFluidAmount() == 0 && ((TRZTileEntityFluidPipe)tileOther).getTank().getFluid() != null){
						return TRZFluidPipeConnectionType.none;
				...
				if (side.equals(EnumFacing.EAST) && (this.east == 2 || this.east == 0)) {
					if (((TRZTileEntityFluidPipe) tileOther).getSide("west") == 1) {
						return TRZFluidPipeConnectionType.none;
					}
					if(tank.getFluidAmount() == 0 && ((TRZTileEntityFluidPipe)tileOther).getTank().getFluid() != null){
						return TRZFluidPipeConnectionType.none;
				...
				if (side.equals(EnumFacing.WEST) && (this.west == 2 || this.west == 0)) {
					if (((TRZTileEntityFluidPipe) tileOther).getSide("east") == 1) {
						return TRZFluidPipeConnectionType.none;
					}
					if(tank.getFluidAmount() == 0 && ((TRZTileEntityFluidPipe)tileOther).getTank().getFluid() != null){
						return TRZFluidPipeConnectionType.none;
