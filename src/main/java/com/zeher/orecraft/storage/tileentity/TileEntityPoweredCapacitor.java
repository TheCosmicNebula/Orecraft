...
public class TileEntityPoweredCapacitor extends TRZTileEntityCapacitor implements ISidedInventory, IInventory, ITickable, TRZICapacitor {
	...
	public int stored;
	public int capacity = TRZCapacitorValues.basicStorage();
	public int input_rate = TRZCapacitorValues.basicInput();
	public int output_rate = TRZCapacitorValues.basicOutput();
	...
	public void update() {
		...
		if (block instanceof BlockPoweredCapacitor) {
			boolean up = ((BlockPoweredCapacitor) block).getSide(EnumFacing.UP, world, this.pos);
			boolean down = ((BlockPoweredCapacitor) block).getSide(EnumFacing.DOWN, world, pos);
			boolean east = ((BlockPoweredCapacitor) block).getSide(EnumFacing.EAST, world, this.pos);
			boolean west = ((BlockPoweredCapacitor) block).getSide(EnumFacing.WEST, world, pos);
			boolean north = ((BlockPoweredCapacitor) block).getSide(EnumFacing.NORTH, world, this.pos);
			boolean south = ((BlockPoweredCapacitor) block).getSide(EnumFacing.SOUTH, world, pos);
