...
public class TileEntityEnergizedCapacitor extends TileEntity implements ISidedInventory, IInventory, ITickable, IStorage {
	...
	public int stored;
	public int capacity = Reference.VALUE.STORAGE.ENERGIZED_CAPACITY;
	public int input_rate = Reference.VALUE.STORAGE.ENERGIZED_INPUT;
	public int output_rate = Reference.VALUE.STORAGE.ENERGIZED_OUTPUT;
	...
	public String getName() {
		return this.hasCustomName() ? this.custom_name : OrecraftReference.GUI_NAME.STORAGE.ENERGIZED.CAPACITOR;
	}
