...
public class GuiPoweredCompressor extends GuiContainer {
	private static final ResourceLocation texture = new ResourceLocation("orecraft:textures/gui/machine/powered/compressor/gui_compressor.png");
	private TileEntityPoweredCompressor inventory;

	public GuiPoweredCompressor(InventoryPlayer par1InventoryPlayer,
			TileEntityPoweredCompressor par2TileEntityCompressor) {
